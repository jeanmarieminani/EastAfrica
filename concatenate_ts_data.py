...
def concatenate_ts_data(input_folder, output_file):
    # Find all CSV files in the input folder
    ts_files = glob.glob(os.path.join(input_folder, "region_*_TS_1981_2022.csv"))
...
# Input folder containing TS files
input_folder = "nasa_power_data_csv"

# Output consolidated file
output_file = "east_africa_TS_1981_2022.csv"

# Run the function
concatenate_ts_data(input_folder, output_file)
